...
| Typed subject/producer and Ed25519 reopening | SubjectKindV1, SubjectBasisV1, validate_monitor |
| Exact FIELD result pins | FIELD_CLOCK_MONITOR_RESULT_HEAD, FIELD_CLOCK_NQ_RESULT_HEAD |
| Claim subset/cannot-testify/refusal/contradiction preservation | bind_input, findings, validate_against |
