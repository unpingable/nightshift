...
| Exact NQ qualify_one closure and claim preservation | validate_nq_findings, expected_nq_contradictions, claim_value_is, bind_input, findings, validate_against |
...
| Executable schema and printable-ASCII parity | tests/test_operational_lineage_schema.py, text, monitor_text |
