...
- [`PROVIDER-CAPACITY-OBSERVATION-V1.md`](PROVIDER-CAPACITY-OBSERVATION-V1.md) — provider-neutral capacity testimony, bounded Codex App Server read probe, and deterministic scheduling policy
